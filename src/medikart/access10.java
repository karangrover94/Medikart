...
public class access10
{
    ...
    access10(String s1,int k,int n,String s2)
  {
      a=s1;
      b=s2;
      i=k;
...
System.out.println("connecttion with Database Succesful");
            ...
            System.out.println("hello");
            PreparedStatement ps=conn.prepareStatement("select medicine_name from medicine where medicine_name like concat('%',?,'%')and (Price between ? and ?)  and type=? ");
